                            ...
                            <div class="card-title">
                                <div class="row">
                                    <div class="col-12 mb-0 py-0">
                                        <h5 class="my-0">Managament Account {{ $customRoles->name}}</h5>
                                    </div>
...
@section('scripts')
    ...
    {{-- <script>
        const _URL = "{{ route('admin.user-has-custom-role.index') }}";
        ...
        $(document).ready(function() {
            ...
            $('#employee').select2({
                ...
                ajax: {
                    url: "{{ route('admin.user-has-custom-role.outstanding.getHrisEmployee') }}",
                    dataType: 'json',
                    delay: 150,
                    processResults: data => {
                        return {
            ...
            $('#savedata').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.user-has-custom-role.outstanding.store') }}",
                    type: "POST",
                    headers: {
