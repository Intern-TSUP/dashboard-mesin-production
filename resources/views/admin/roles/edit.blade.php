                                ...
                                <div class="card-content">
                                    <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="jobLvl" class="form-control"
                                        ...
                                        <div class="mb-3">
                                                ...
                                                <div>
                                                    <div class="d-flex justify-content-start align-items-center mb-2">
                                                        ...
                                                        <p class="mb-0 fw-semibold text-capitalize fs-5 mt-5">
                                                            {{ $getLabel($group) }}
                                                            <span
                                                                class="badge ms-2 badge-status badge-{{ $group }}">Not
                                                                Actived</span>
                                                        </p>
                                                    </div>
                                            ...
                                            @php
                                                $adminRoutes = [];
                                                $groupLabels = [
                                                    'department' => 'Manage HRIS Permission Job Level',
                                                    'roles' => 'Roles Management',
                                                    'permission' => 'Permission Role Access',
                                                    'permissionLine' => 'Permission Line',
                                                    'user' => 'Manage User',
                                                    'user-has-custom-role' => 'Manage User Has Custom Role',
                                                    'settings' => 'Settings',
