                    ...
                    <div class="card">
                            ...
                            <div class="card-title">
                                <div class="row">
                                    <div class="col-12 mb-0 py-0">
                                        <h5 class="my-0">Managament Account Verificator</h5>
                                    </div>
                                    <div class="col-12 my-0 py-0">
                                        <span class="fw-light fs-8">Create Or Update Or Delete User</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="card-content">
                                ...
                                <table id="dtUserRev" class="table table-bordered align-middle table-row-dashed fs-6 gy-5">
                                    <thead>
...
@section('scripts')
    ...
    <script>
        const _URL = "{{ route('admin.verifikator.getDT') }}";
        ...
        $(document).ready(function() {
            ...
            let userTable = $("#dtUserRev").DataTable({
                processing: true,
                serverSide: true,
                order: [
                    [1, 'desc']
            ...
            $('#employee').select2({
                ...
                ajax: {
                    url: "{{ route('admin.verifikator.getHrisEmployee') }}",
                    dataType: 'json',
                    delay: 150,
                    processResults: data => {
                        return {
            ...
            $('#savedata').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.verifikator.store') }}",
                    type: "POST",
                    headers: {
