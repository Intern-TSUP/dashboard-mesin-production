                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="#" class="text-muted text-hover-primary">Department</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-content">
                        ...
                        <table id="dt_department" class="table table-bordered table-striped align-middle table-row-dashed fs-6 gy-5 border rounded">
                            <thead>
...
@section('scripts')
    ...
    <script>
        ...
        const _URL = "{{ route('admin.department.getDataTableDepartment') }}";
        ...
        $(document).ready(function () {
            ...
            let DT = $("#dt_department").DataTable({
